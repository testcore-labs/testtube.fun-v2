...
We highly appreciate you sending us a postcard shadow-sm from your hometown, mentioning which of our package(s) you are using. You'll find our address on [our contact page](https://spatie.be/about-us). We publish all received postcards on [our virtual postcard shadow-sm wall](https://spatie.be/open-source/postcards).
...
You're free to use this package, but if it makes it to your production environment we highly appreciate you sending us a postcard shadow-sm from your hometown, mentioning which of our package(s) you are using.
